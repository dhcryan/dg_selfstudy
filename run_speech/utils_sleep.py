...
def load_and_dump(seed=1234):
    ...
    root = 'C:\\Users\\dhc40\\manyDG\\data\\sleep\\sleep-edf-database-expanded-1.0.0\\cassette_processed'
    ...
    pickle.dump(test_pat_dict, open('C:\\Users\\dhc40\\manyDG\\data\\sleep\\test_pat_map_sleep.pkl', 'wb'))
    pickle.dump(val_pat_dict, open('C:\\Users\\dhc40\\manyDG\\data\\sleep\\val_pat_map_sleep.pkl', 'wb'))
    pickle.dump(train_pat_dict, open('C:\\Users\\dhc40\\manyDG\\data\\sleep\\train_pat_map_sleep.pkl', 'wb'))
    return train_pat_dict, test_pat_dict, val_pat_dict

def load():
    test_pat_map = pickle.load(open('C:\\Users\\dhc40\\manyDG\\data\\sleep\\test_pat_map_sleep.pkl', 'rb'))
    val_pat_map = pickle.load(open('C:\\Users\\dhc40\\manyDG\\data\\sleep\\val_pat_map_sleep.pkl', 'rb'))
    train_pat_map = pickle.load(open('C:\\Users\\dhc40\\manyDG\\data\\sleep\\train_pat_map_sleep.pkl', 'rb'))
